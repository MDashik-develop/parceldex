    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form role="form"
                        action="{{ route('branch.parcel.confirmPickupRiderRunGenerateEdit', $riderRun->id) }}"
                        method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                        @csrf
                        @method('PATCH')
                        <input type="hidden" name="total_run_parcel" id="total_run_parcel"
                            value=" {{ $riderRun->total_run_parcel }}">
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table ">
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <select name="rider_id" id="rider_id" class="form-control select2"
                                                            ...
                                                            <option value="{{ $riderRun->rider->id }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 55%">
                                                        <span
                                                            id="view_rider_contact_number">{{ $riderRun->rider->contact_number }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 55%">
                                                        <span
                                                            id="view_rider_address">{{ $riderRun->rider->address }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <span id="view_total_run_parcel"> {{ $riderRun->total_run_parcel }}
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            @foreach ($cart as $item)
                                                                <div class="badge badge-info" style="font-size: 20px;">
                                                                    ...
                                                                    <span style="cursor: pointer;"
                                                                        onclick="return delete_parcel({{ $item->id }})">
                                                                        <i class="fa fa-trash text-danger"
                                                                            style="color:black"></i>
                                                                    </span>
                                                                </div>
                                                            @endforeach
                                                            <input type="hidden" id="cart_total_item"
                                                                value="{{ $totalItem }}">
                                                        @endif
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="parcel_invoice" id="parcel_invoice" class="form-control"
                                            placeholder="Enter Parcel Invoice Barcode" onkeypress="return add_parcel(event)"
                                    ...
                                    border: 1px solid rgb(62, 196, 118);">
                                            ...
                                            @foreach ($merchants as $merchant)
                                                <option value="{{ $merchant->merchant->id }}">
                                                    {{ $merchant->merchant->company_name }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                                ...
                                                <tr style="background-color: #f4f4f4;">
                                                    <td class="text-center">
                                                        <input type="checkbox" id="checkItem" class="parcelId"
                                                            value="{{ $rider_run_detail->parcel->id }}">
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('parcel.printParcel', $rider_run_detail->parcel->id) }}"
                                                            class="btn btn-success btn-sm" title="Print Parcel"
                                                            target="_blank">
                                        ...
                                        @if ($parcels->count() > 0)
                                            @foreach ($parcels as $parcel)
                                                <tr style="background-color: #f4f4f4;">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('parcel.printParcel', $parcel->id) }}"
                                                            class="btn btn-success btn-sm" title="Print Parcel"
                                                            target="_blank">
                                                            <i class="fas fa-print"></i> </a>
                                                    </td>
