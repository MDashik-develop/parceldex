...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Merchant Push Request List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Merchant Push Request List</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Merchant Push Request List </h3>
    ...
    <script>
        $(document).on('change', '.district', function() {
            ...
            $.ajax({
                ...
                dataType: "JSON",
                data: {
                    merchant_id: {{ $merchant->id }}, // Ensure this value is correctly populated
