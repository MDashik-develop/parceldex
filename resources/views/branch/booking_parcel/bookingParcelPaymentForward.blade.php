...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="paymentForwardForm"
                        action="{{ route('branch.bookingParcelPayment.confirmPaymentForwardToAccounts') }}" method="POST"
                        enctype="multipart/form-data" onsubmit="return submit_data()">
                        @csrf
                                                ...
                                                <tr style="background-color: #f4f4f4;">
                                                    <td class="text-center">
                                                        <input type="checkbox" name="payment_id[]"
                                                            id="checkItem_{{ $i }}" class="paymentId"
                                                            value="{{ $payment->id }}">
                                                    </td>
                                                    <td class="text-center">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        window.location =
                        "{{ route('branch.bookingParcelPayment.paymentForwardToAccounts') }}";
                        //$('#preview_file').html('');
