                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @if (auth()->guard('admin')->user()->type == 1)
                                ...
                                <a href="{{ route('admin.merchant.merchantBulkImport') }}"
                                ...
                                <table id="yajraDatatable" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Parent Merchant</th>
        ...
        window.onload = function() {
            ...
            var table = $('#yajraDatatable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'parent_merchant.company_name',
                        name: 'parent_merchant.company_name',
                        class: "text-center",
                        orderable: false,
                        searchable: false,
                    ...
                    },
                    {
                        ...
                        name: 'area.name',
                        class: "text-center",
                        render: (data, type, row) => (row && row.area) ? data : "--"
                    },
                    {
                        data: 'district.name',
                        name: 'district.name',
                        class: "text-center",
                        render: (data, type, row) => (row && row.district) ? data : "--"
                    },
                    {
                        data: 'status',
                        name: 'status',
