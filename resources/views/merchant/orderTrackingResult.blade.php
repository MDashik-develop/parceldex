                                    ...
                                    switch($parcelLog->status){
                                        ...
                                        case 23 :
                                            ...
                                            if(!empty($parcelLog->admin)){
                                                ...
                                                if(!empty($parcelLog->delivery_rider)){
                                                    $to_user    = "Delivery Rider : ".$parcelLog->delivery_rider->name." (Reschedule Date : " .\Carbon\Carbon::parse($parcelLog->reschedule_parcel_date)->format('d/m/Y') .") Note:".$parcelLog->note;
                                                }
                                            }
                                            break;
                                        case 24 :
