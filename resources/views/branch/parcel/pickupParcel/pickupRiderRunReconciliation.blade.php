...
<div class="modal-body">
    <form role="form" action="{{ route('branch.parcel.confirmPickupRiderRunReconciliation', $riderRun->id) }}"
                                        ...
                                        @foreach ($riderRun->rider_run_details->sortBy('parcel.merchant.company_name') as $rider_run_detail)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $rider_run_detail->parcel->parcel_invoice }} </td>
                                                <td class="text-center">
                                                    @php
                                                ...
                                                <td class="text-center">
                                                    <select name="status[]"
                                                        ...
                                                        style="width: 100%" onchange="return rider_run_status()">
                                                        ...
                                                        <option value="7"
                                                            @if ($rider_run_detail->status == 7 || $rider_run_detail->status == 2) selected ="" @endif>Run
                                                            Complete</option>
                                                        <option value="5"
                                                            @if ($rider_run_detail->status != 6 && $rider_run_detail->status != 7 && $rider_run_detail->status != 2) selected ="" @endif>Run
                                                            Reject</option>
        ...
        <div class="card-footer text-center">
            <button id="submitt" type="submit" class="btn btn-success">Confirm
            </button>
