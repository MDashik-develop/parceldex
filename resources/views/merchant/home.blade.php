...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
            ...
            <a href="https://play.google.com/store/apps/details?id=com.parceldexltd.merchant&pcampaignid=web_share" target="_blank"><img height="40" src="{{ asset('image/playstore.png') }}"></a>
        </div>
            </div>
            <div class="col-sm-6">
...
<!-- //New By Humayun -->
        ...
        <div class="row admin_client_info justify-content-center">
            <div class="col-lg-3 col-6 text-right" style="padding: 0px 5px !important;">
                <button type="button" class="btn btn-primary btn-block" href="#" style="font-size: large; border-radius: 1.5rem; ">
          ...
          <!-- /.col -->
            ...
            <div class="info-box mb-3 bg-success">
              ...
              <div class="info-box-content2">
                ...
                <span class="info-box-number2">Upcoming </span>
