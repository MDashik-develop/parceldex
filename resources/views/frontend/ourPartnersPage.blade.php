...
@section('seo-meta')
    @php
        $seoMeta = App\Models\SeoMeta::where('page_name', 'OurPartnersPage')->first();
    @endphp
...
<div class="main-ourPatner-page">
	...
	<div class="common-hero-section text-center">
		...
		<p class="mb-4" style="color: #6C757D;">
			With the expansion of Trax in its niche, it has also partnered with  <br> established brands across the industry. Have a look at them below.
		</p>
    ...
    <div class="container mb-4">
        <div class="patner-wrapper patner-wrapper1 d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInUp" style="gap: 30px !important; padding: 110px 0;">
            <p class="brands-logos-p p-1 rounded">Fashion</p>
            <div class="container-fluid mx-0">
                <div class="patner d-flex flex-wrap justify-content-between align-items-center gap-4">
        ...
        <div class="patner-wrapper patner-wrapper2 d-flex flex-column justify-content-center align-items-center animate__animated animate__fadeInUp " style="gap: 30px !important; padding: 110px 0;">
