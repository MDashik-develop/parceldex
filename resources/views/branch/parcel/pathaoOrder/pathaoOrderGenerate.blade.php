    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form" action="{{ route('branch.parcel.confirmPathaoOrderGenerate') }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @csrf
...
{{--                                            </tr>-->--}}
                                                ...
                                                <td colspan="2">
                                                    <select name="city_id" id="city_id" class="form-control select2" style="width: 100%">
                                                        ...
                                                        @foreach ($pathao_cities as $pathao_city)
                                                            <option value="{{ $pathao_city['city_id'] }}"> {{ $pathao_city['city_name'] }} </option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Zone</th>
                                                <td colspan="2">
                                                    <select name="zone_id" id="zone_id" class="form-control select2" style="width: 100%" disabled>
