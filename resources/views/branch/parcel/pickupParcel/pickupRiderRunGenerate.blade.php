        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" action="{{ route('branch.parcel.confirmPickupRiderRunGenerate') }}"
                                    ...
                                    <div class="col-md-12">
                                        <fieldset>
                                            ...
                                            <div class="col-md-12 text-center">
                                                <button type="submit" id="PRRGenerate"
                        ...
                        <div class="col-md-12 row" style="margin-top: 20px;">
                            ...
                            <div class="col-md-2">
                                <button type="button" style="margin-top: 5px;" class="btn btn-info btn-block"
