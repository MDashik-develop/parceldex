    ...
    <div class="sidebar">
        <div class="user-panel mt-3 mb-3 text-center">
            @if (!empty(auth()->guard('merchant')->user()->image))
                <div class="image">
                    <img src="{{ asset('uploads/merchant/' . auth()->guard('merchant')->user()->image) }} "
                        class="img-thumbnail elevation-2" alt="Merchant Photo">
                </div>
            @else
                <div class="image">
        ...
        <a href="{{ route('merchant.parcel.add') }}"><button class="btn btn-block btn-lg btn-add-parcel">Add New
                Parcel</button></a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @if (auth()->guard('merchant')->user()->branch_id)
                    <li class="nav-item">
                        <a href="{{ route('merchant.parcel.add') }}"
                            class="nav-link {{ $child_menu == 'addParcel' ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('merchant.parcel.list') }}"
                            class="nav-link {{ $child_menu == 'parcelList' ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    ...
                    <a href="{{ route('merchant.account.deliveryPaymentList') }}"
                ...
                <li class="nav-item">
                    <a href="{{ route('merchant.serviceCharge') }}"
                        class="nav-link {{ $child_menu == 'serviceCharge' ? 'active' : '' }}">
