...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form role="form" action="{{ route('admin.parcel.confirmParcelPaymentGenerate') }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <table class="table">
                                                ...
                                                <input type="hidden" name="payment_request_id" id="payment_request_id"
                                                    value="{{ $parcelPaymentRequest->id }}">
                                                <input type="hidden" name="merchant_id" id="merchant_id"
                                                    value="{{ $parcelPaymentRequest->merchant_id }}">
                                                <tr>
                                                    <th>Date</th>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 55%">
                                                        <span
                                                            id="view_merchant_name">{{ $parcelPaymentRequest->merchant->name }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 55%">
                                                        <span
                                                            id="view_merchant_contact_number">{{ $parcelPaymentRequest->merchant->contact_number }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 55%">
                                                        <span
                                                            id="view_merchant_address">{{ $parcelPaymentRequest->merchant->address }}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <span id="view_merchant_request_amount">
                                                            {{ $parcelPaymentRequest->request_amount }} </span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th> Payment Type</th>
                                                    <td colspan="2">
                                                        <select name="paid_payment_type" id="paid_payment_type"
                                                            class="form-control">
                                                            <?php
                                                            $payment_methods = [
