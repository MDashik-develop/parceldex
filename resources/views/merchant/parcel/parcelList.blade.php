                                ...
                                <table id="yajraDatatable" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%"> Return Status</th>
    ...
    <script>
        window.onload = function() {
            ...
            function load_data(parcel_status = '', parcel_invoice = '', merchant_order_id = '',
                customer_contact_number = '', from_date = '', to_date = '') {
            ...
            $('#filter').click(function() {
                ...
                load_data(parcel_status, parcel_invoice, merchant_order_id, customer_contact_number, from_date,
                    to_date);
            });
