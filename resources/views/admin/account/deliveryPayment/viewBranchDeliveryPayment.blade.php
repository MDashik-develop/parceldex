                        ...
                        <div class="col-md-6">
                            <table class="table table-style">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%">
                                        {{ number_format($parcelDeliveryPayment->total_payment_amount, 2) }} </td>
                                </tr>
                                ...
                                @if ($parcelDeliveryPayment->status != 1)
                                    <tr>
                                        ...
                                        <td style="width: 10%"> : </td>
                                        <td style="width: 50%">
                                            {{ $parcelDeliveryPayment->total_payment_received_parcel }} </td>
                                    </tr>
                                    <tr>
                                        <th style="width: 40%">Total Received Payment Amount </th>
                                        <td style="width: 10%"> : </td>
                                        <td style="width: 50%">
                                            {{ number_format($parcelDeliveryPayment->total_payment_received_amount, 2) }}
                                        </td>
                                    </tr>
                                @endif
                            ...
                            <fieldset>
                                ...
                                <table class="table table-style">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%"> : </td>
                                        <td style="width: 50%"> {{ $parcelDeliveryPayment->branch->contact_number }}
                                        </td>
                                    </tr>
                                    <tr>
