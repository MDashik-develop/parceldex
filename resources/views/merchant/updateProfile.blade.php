...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="offset-md-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('merchant.confirmUpdateProfile') }}"
    ...
    @endforeach
                                                ...
                                                <input type="hidden" name="payment_recived_by"
                                                    value="{{ $merchant->payment_recived_by }}" id="">
                                                <input type="hidden" name="bank_account_no"
                                                    value="{{ $merchant->bank_account_no }}" id="">
                                                <input type="hidden" name="bank_account_name"
                                                    value="{{ $merchant->bank_account_name }}" id="">
                                                <input type="hidden" name="bank_route_no"
                                                    value="{{ $merchant->bank_route_no }}" id="">
                                                <input type="hidden" name="bank_branch_name"
                                                    value="{{ $merchant->bank_branch_name }}" id="">
                                                <input type="hidden" name="bank_name"
                                                    value="{{ $merchant->bank_name }}" id="">
                                                <input type="hidden" name="nagad_number"
                                                    value="{{ $merchant->nagad_number }}" id="">
                                                    ...
                                                    <div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="payment_recived_by" id="payment_recived_by"
                                                                class="form-control select2" style="width: 100%">
                                                                <option value="0"
                                                                    {{ $merchant->payment_recived_by == 0 ? 'selected' : '' }}>
                                                                    Not
                                                                    selected</option>
                                                                <option value="1"
                                                                    {{ $merchant->payment_recived_by == 1 ? 'selected' : '' }}>
                                                                    Cash
                                                                </option>
                                                                <option value="2"
                                                                ...
                                                                <option value="5"
                                                                    {{ $merchant->payment_recived_by == 5 ? 'selected' : '' }}>
                                                                    Bank
                                                                </option>
                                                            </select>
                                                        </div>
            ...
            'Woori Bank',
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input type="text" name="bank_route_no"
                                                                        id="bank_route_no"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label for="bank_account_name">Bank A/C Owner
                                                                        Name</label>
