                        ...
                        <div class="card-body">
                            <div class=" col-md-12 ">
                                <div class="card card-primary">
                                    <form role="form"
                                        action="{{ route('merchant.parcel.merchantBulkParcelImportEntry') }}" method="POST"
                                        ...
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <th width="10%"> Alternative Number</th>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="{{ route('merchant.parcel.merchantBulkParcelImport.reset') }}"
