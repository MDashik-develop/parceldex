    ...
    <script>
        window.onload = function() {
            ...
            function load_data(merchant_id = '', status = '', from_date = '', to_date = '') {
                var table = $('#yajraDatatable').DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'total_collect_amount',
                            name: 'total_collect_amount',
                            class: "text-center"
                        },
                        {
                            data: 'customer_collect_amount',
                            name: 'customer_collect_amount',
                            class: "text-center"
                        },
                        {
                            data: 'total_charge',
            ...
            $('#yajraDatatable').on('click', '.view-modal', function() {
                ...
                var url =
                    "{{ route('admin.account.viewMerchantDeliveryPayment', ':parcel_delivery_payment_id') }}";
            ...
            $('#yajraDatatable').on('click', '.merchant-delivery-payment-accept', function() {
                ...
                var parcel_delivery_payment_id = $(this).attr('parcel_delivery_payment_id');
                var url =
                    "{{ route('admin.account.merchantDeliveryPaymentAccept', ':parcel_delivery_payment_id') }}";
                url = url.replace(':parcel_delivery_payment_id', parcel_delivery_payment_id);
                $('#showResult').html('');
                if (parcel_delivery_payment_id.length != 0) {
                    $.ajax({
            ...
            $('#yajraDatatable').on('click', '.accept-branch-delivery-payment', function() {
                var parcel_delivery_payment_id = $(this).attr('parcel_delivery_payment_id');
                var url =
                    "{{ route('admin.account.acceptBranchDeliveryPayment', ':parcel_delivery_payment_id') }}";
                url = url.replace(':parcel_delivery_payment_id', parcel_delivery_payment_id);
                $('#showResult').html('');
                if (parcel_delivery_payment_id.length != 0) {
                    $.ajax({
            ...
            $('#yajraDatatable').on('click', '.reject-branch-delivery-payment', function() {
                var parcel_delivery_payment_id = $(this).attr('parcel_delivery_payment_id');
                var url =
                    "{{ route('admin.account.rejectBranchDeliveryPayment', ':parcel_delivery_payment_id') }}";
                url = url.replace(':parcel_delivery_payment_id', parcel_delivery_payment_id);
                $('#showResult').html('');
                if (parcel_delivery_payment_id.length != 0) {
                    $.ajax({
