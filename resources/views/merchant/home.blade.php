...
<!-- //New By Humayun -->
        ...
        <div class="row admin_client_info justify-content-center">
            <div class="col-lg-3 col-6 text-right" style="padding: 0px 5px !important;">
                <button type="button" class="btn btn-primary btn-block" href="#" style=" font-family: cursive; font-size: large; border-radius: 1.5rem; ">
            ...
            <div class="col-lg-3 col-6 d-flex align-items-center justify-content-center bg-warning" 
                @if($total_pending_payment <= 0) style="font-size: large; font-family: cursive; padding: 0px; border-radius: 1.5rem;  pointer-events:  none;" @endif style=" font-size: x-large; font-family: cursive;  padding: 0px;!important; border-radius: 1.5rem;">
        ...
        <div class="row" style="margin-top: 20px;">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Delivery Pending</span>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    @php
                    $parcelStatus = returnParcelStatusNameForMerchant($r_order->status, $r_order->delivery_type, $r_order->payment_type);
...
">
          ...
          <div class="col-md-3">
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content2">
                <span class="info-box-text">Payment Invoice</span>
            ...
            <!-- /.info-box -->
            <div class="info-box mb-3" style="background-color: #a728a3!important;">
              <span class="info-box-icon"><i class="fa fa-credit-card"></i></span>

              <div class="info-box-content2">
                <span class="info-box-text">Due Amount</span>
                <span class="info-box-number2">{{ number_format($total_pending_payment,2, '.', '') }} TK </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <!-- /.col -->
            ...
            <div class="info-box mb-3 bg-warning">
              ...
              <div class="info-box-content2">
                <span class="info-box-text">Parcel In Processing Amount</span>
                <span class="info-box-number2"> {{  number_format($parcel_in_process,2) }} TK  </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
