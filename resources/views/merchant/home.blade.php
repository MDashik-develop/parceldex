                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <div class="info-box">
                        ...
                        <div class="info-box-content" style="text-align: center">
                            ...
                            <h5 class="info-box-text">Today's Pickup</h5>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3" style="text-align: center">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-text">Pickup Pending</h5>
            ...
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-12 col-sm-6 col-md-2" style="text-align: center">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-text">Delivered</h5>
                ...
                <div class="col-12 col-sm-6 col-md-3" style="text-align: center">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            <span
                                class="info-box-number">{{ $counter_data['total_partial_delivery_complete_parcel'] }} <sup><small style="color: #007bff; font-size: 15px;">{{ ($counter_data['total_partial_delivery_complete_parcel'] / 100) * $counter_data['total_parcel']; }}%</small></sup></span>
                            <h5 class="info-box-text">Partial Delivered</h5>
                            <a href="{{ route('merchant.parcel.filterList', 'delivered_parcel') }}"
                                class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                ...
                <div class="col-12 col-sm-6 col-md-2" style="text-align: center">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-text">Cancelled</h5>
                ...
                <div class="col-12 col-sm-6 col-md-3" style="text-align: center">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <h5 class="info-box-text">Parcel In Progress</h5>
