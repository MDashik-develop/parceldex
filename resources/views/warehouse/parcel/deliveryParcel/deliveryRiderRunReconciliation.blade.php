                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <select name="complete_type[]"
                                                    ...
                                                    <option value="21"
                                                        @if ($rider_run_detail->parcel->status == 21) selected ="" @endif>Complete
                                                        Delivery</option>
                                                    <option value="22"
                                                        @if ($rider_run_detail->parcel->status == 22) selected ="" @endif>Partial
                                                        Delivery</option>
                                                    <option value="23"
                                                        @if ($rider_run_detail->parcel->status == 23) selected ="" @endif>
                                                        Reschedule Delivery</option>
                                                    <option value="24"
                                                        @if ($rider_run_detail->parcel->status == 24) selected ="" @endif>Return
                                                        Delivery</option>
                                                </select>
                                            </td>
                                            <td class="text-center">
                                                <div id="div_customer_collect_amount{{ $rider_run_detail->id }}"
                                                    ...
                                                    <input type="number" name="customer_collect_amount[]"
                                                        ...
                                                        placeholder="Customer Payment Amount" style="width: 100%">
                                                </div>
                                                <div id="div_reschedule_parcel_date{{ $rider_run_detail->id }}"
                                                    ...
                                                    <input type="date" name="reschedule_parcel_date[]"
                                                        ...
                                                        value="{{ date('Y-m-d', strtotime($rider_run_detail->parcel->reschedule_parcel_date)) }}">
                                                </div>
                                            </td>
                                            <td class="text-center">
