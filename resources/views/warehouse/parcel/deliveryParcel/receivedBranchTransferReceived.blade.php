                                    ...
                                    <tbody>
                                        @foreach ($deliveryBranchTransfer->delivery_branch_transfer_details as $delivery_branch_transfer_detail)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ $delivery_branch_transfer_detail->parcel->merchant->name }}
                                                </td>
                                                <td class="text-center">
                                                    {{ $delivery_branch_transfer_detail->parcel->customer_name }} </td>
                                                <td class="text-center">
                                                    <select name="delivery_branch_transfer_status[]"
                                                        class="form-control select2 delivery_branch_transfer_status"
                                                        style="width: 100%"
