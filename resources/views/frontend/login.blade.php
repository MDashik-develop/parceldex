    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <h3 style="color: #00509D; font-weight: bold; margin-bottom: 20px;" class="login-box-msg">Login to Parceldex Using
                     </h3>
                ...
                <form action="{{ route('frontend.login') }}" method="post">
                    ...
                    <p class="mt-3" style="text-align: center;">New to Parceldex? <a href="/merchant-registration">Sign Up Now</a></p>
                </form>
            </div>
        </div>

        <div style="text-align: center; margin-top: 30px;">
            Download Our App &nbsp; &nbsp; <a href="https://play.google.com/store/apps/details?id=com.parceldexltd.merchant&pcampaignid=web_share"
