...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="offset-md-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.merchant.update', $merchant->id) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="name" id="name"
                                                        value="{{ $merchant->name ?? old('name') }}" class="form-control"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" name="contact_number" id="contact_number"
                                                            value="{{ $merchant->contact_number ?? old('contact_number') }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="fb_url"
                                                            name="fb_url"
                                                            value="{{ $merchant->fb_url ?? old('fb_url') }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" class="form-control" id="web_url"
                                                            name="web_url"
                                                            value="{{ $merchant->web_url ?? old('web_url') }}"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="password" name="password" id="password"
                                                        value="{{ $merchant->cod_charge ?? old('password') }}"
                                                    ...
                                                    <div class="col-md-12 row" style="margin-top: 20px;">
                                                        ...
                                                        @foreach ($serviceAreas as $serviceArea)
                                                            @php
                                                                $cod_charge = '';
                                                                foreach (
                                                                    $merchant->service_area_cod_charges
                                                                    as $service_area_cod_charge
                                                                ) {
                                                                    if (
                                                                        $service_area_cod_charge->id == $serviceArea->id
                                                                    ) {
                                                                        $cod_charge = floatval(
                                                                            $service_area_cod_charge->pivot->cod_charge,
                                                                        );
                                                                    }
                                                                }
                                                            @endphp
                                                            <div class="col-md-4 col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="cod_charge[]"
                                                                        ...
                                                                        placeholder="{{ $serviceArea->name }} COD Charge "
                                                                        value="{{ $cod_charge }}" step="any"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                        ...
                                                        @foreach ($serviceAreas as $serviceArea)
                                                            @php
                                                                ...
                                                                foreach (
                                                                    ...
                                                                    as $service_area_charge
                                                                ) {
                                                                    if ($service_area_charge->id == $serviceArea->id) {
                                                                        $charge = floatval(
                                                                            $service_area_charge->pivot->charge,
                                                                        );
                                                                    }
                                                                }
                                                            @endphp
                                                        ...
                                                        @foreach ($serviceAreas as $serviceArea)
                                                            @php
                                                                ...
                                                                foreach (
                                                                    ...
                                                                    as $service_area_return_charge
                                                                ) {
                                                                    if (
                                                                        $service_area_return_charge->id ==
                                                                        $serviceArea->id
                                                                    ) {
                                                                        $return_charge = floatval(
                                                                            $service_area_return_charge->pivot
                                                                                ->return_charge,
                                                                        );
                                                                    }
                                                                }
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="status" id="status" class="form-control select2"
                                                        style="width: 100%">
                                                        <option value="1"
                                                            {{ $merchant->status == 1 ? 'selected' : '' }}>
                                                            Active</option>
                                                        <option value="0"
                                                            {{ $merchant->status == 0 ? 'selected' : '' }}>
                                                            Inactive</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="otp_token_status"> Phone Status </label>
                                                    <select name="otp_token_status" id="otp_token_status"
                                                        class="form-control select2" style="width: 100%">
                                                        <option value="1"
                                                            {{ $merchant->otp_token_status == 1 ? 'selected' : '' }}>
                                                            Verified
                                                        </option>
                                                        <option value="0"
                                                            {{ $merchant->otp_token_status == 0 ? 'selected' : '' }}>Not
                                                            Verified</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" name="email_verified_at" id="email_verified_at"
                                                        value="{{ $merchant->email_verified_at ? date('Y-m-d', strtotime($merchant->email_verified_at)) : '' }}"
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="payment_recived_by" id="payment_recived_by"
                                                        class="form-control select2" style="width: 100%">
                                                        <option value="0"
                                                            {{ $merchant->payment_recived_by == 0 ? 'selected' : '' }}>Not
                                                            selected</option>
                                                        <option value="1"
                                                            {{ $merchant->payment_recived_by == 1 ? 'selected' : '' }}>Cash
                                                        </option>
                                                        <option value="2"
                                                            {{ $merchant->payment_recived_by == 2 ? 'selected' : '' }}>
                                                            Bkash
                                                        </option>
                                                        <option value="3"
                                                            {{ $merchant->payment_recived_by == 3 ? 'selected' : '' }}>
                                                            Nagad
                                                        </option>
                                                        <option value="4"
                                                            {{ $merchant->payment_recived_by == 4 ? 'selected' : '' }}>
                                                            Rocket
                                                        </option>
                                                        <option value="5"
                                                            {{ $merchant->payment_recived_by == 5 ? 'selected' : '' }}>Bank
                                                        </option>
                                                    </select>
                                                </div>

                                                @if ($merchant->parent_merchant_id)
                                                    <div class="col-md-4">
    ...
    @endif-->
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="bank_name" id="bank_name"
                                                                ...
                                                                <option value="Select Type"
                                                                    {{ old('bank_name') == 'Select Type' || ($merchant && $merchant->bank_name == 'Select Type') ? 'selected' : '' }}>
                                                                    Select Type</option>
            ...
            'Woori Bank',
                                                                    ...
                                                                    <option value="{{ $bank }}"
                                                                        {{ old('bank_name') == $bank || ($merchant && $merchant->bank_name == $bank) ? 'selected' : '' }}>
                                                                        {{ $bank }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="bank_branch_name"
                                                                id="bank_branch_name"
                                                                value="{{ $merchant->bank_branch_name ?? old('bank_branch_name') }}"
                                                                class="form-control" placeholder="Bank Branch Name">
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label for="bank_route_no">Bank Route Number</label>
                                                            <input type="text" name="bank_route_no" id="bank_route_no"
                                                                value="{{ $merchant->bank_route_no ?? old('bank_route_no') }}"
                                                                class="form-control" placeholder="Bank Route Number">
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="bank_account_name"
                                                                ...
                                                                value="{{ $merchant->bank_account_name ?? old('bank_account_name') }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="bank_account_no"
                                                                id="bank_account_no"
                                                                value="{{ $merchant->bank_account_no ?? old('bank_account_no') }}"
