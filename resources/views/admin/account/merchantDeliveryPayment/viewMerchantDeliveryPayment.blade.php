                        ...
                        <div class="col-md-6">
                            <table class="table table-style">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%"> : </td>
                                    <td style="width: 50%"> {{ $parcelMerchantDeliveryPayment->total_payment_parcel }}
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <fieldset>
                                ...
                                <table class="table table-style">
                                    <tr>
                                        ...
                                        <td style="width: 10%"> : </td>
                                        <td style="width: 50%"> {{ $parcelMerchantDeliveryPayment->merchant->name }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 10%"> : </td>
                                        <td style="width: 50%"> {{ $parcelMerchantDeliveryPayment->merchant->address }}
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <table class="table table-style">
                                        <tr>
                                            <th style="width: 40%"> Name </th>
                                            <td style="width: 10%"> : </td>
                                            <td style="width: 50%"> {{ $parcelMerchantDeliveryPayment->admin->name }}
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
