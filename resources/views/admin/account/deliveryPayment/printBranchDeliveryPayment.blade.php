                ...
                <div class="col-md-6">
                    <table class="table table-style">
                        ...
                        <tr>
                            ...
                            <td style="width: 10%"> :</td>
                            <td style="width: 50%">
                                {{ \Carbon\Carbon::parse($parcelDeliveryPayment->date_time)->format('d/m/Y H:i:s') }}
                            </td>
                        </tr>
                        ...
                        @if ($parcelDeliveryPayment->status != 1)
                            <tr>
                                ...
                                <td style="width: 10%"> :</td>
                                <td style="width: 50%">
                                    {{ \Carbon\Carbon::parse($parcelDeliveryPayment->action_date_time)->format('d/m/Y H:i:s') }}
                                </td>
                            </tr>
                        @endif
                        ...
                        <tr>
                            ...
                            <td style="width: 10%"> :</td>
                            <td style="width: 50%"> {{ number_format($parcelDeliveryPayment->total_payment_amount, 2) }}
                            </td>
                        </tr>
                        ...
                        @if ($parcelDeliveryPayment->status != 1)
                            <tr>
                                ...
                                <td style="width: 10%"> :</td>
                                <td style="width: 50%"> {{ $parcelDeliveryPayment->total_payment_received_parcel }}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 10%"> :</td>
                                <td style="width: 50%">
                                    {{ number_format($parcelDeliveryPayment->total_payment_received_amount, 2) }} </td>
                            </tr>
                        @endif
                    ...
                    <table class="table table-style table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="15%" class="text-center">Customer Phone</th>
                                <th width="10%" class="text-center">Amount to be Collected</th>
                            ...
                            @foreach ($parcelDeliveryPayment->parcel_delivery_payment_details as $parcel_delivery_payment_detail)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ $parcel_delivery_payment_detail->parcel->parcel_invoice }} </td>
                                    <td class="text-center">
                                        {{ $parcel_delivery_payment_detail->parcel->merchant_order_id ?? '---' }}
                                    </td>
                                    @php
                                        $status = returnParcelStatusNameForAdmin(
