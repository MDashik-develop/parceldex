...
@section('content')
    @php
        ...
        $parcel = App\Models\Parcel::with(
            ...
            ->where('parcel_invoice', $parcel_invoice)
            ->first();

        $parcelLogs = App\Models\ParcelLog::with(
            'pickup_branch',
            'pickup_branch_user',
            'pickup_rider',
            'delivery_branch',
        ...
        $parcelBranchPaymentDeltails = App\Models\ParcelDeliveryPaymentDetail::where('parcel_id', $parcel->id)
            ->orderBy('id', 'DESC')
            ->with('parcel_delivery_payment')
            ->get();
        $parcelMerchantPaymentDeltails = App\Models\ParcelMerchantDeliveryPaymentDetail::where('parcel_id', $parcel->id)
            ->orderBy('id', 'DESC')
            ...
            <div class="parcel-details-container">
                ...
                <div class="section">
                    <div class="merchant-details">
                        ...
                        <p><strong>{{ $parcel->merchant->company_name }}</strong></p>
                    ...
                    <div class="parcel-details">
                        ...
                        <section style="display: flex; align-content: center;">
                            ...
                            <section class="pl-100">
                                ...
                                <p>: {{ number_format($parcel->total_collect_amount, 0) }}
                                    Tk</p>
                                <p>: {{ number_format($parcel->cancel_amount_collection > 0 ? $parcel->cancel_amount_collection : $parcel->customer_collect_amount, 0) }}
                                    Tk</p>
                            </section>
                    </div>
                </div>
                ...
                <div class="section">
                    <div class="customer-details">
                        @if ($parcel?->pickup_rider)
                            ...
                            <p>Pickup Rider - {{ $parcel?->pickup_rider?->name }} - {{ $parcel?->pickup_rider?->r_id }}
                            </p>
                        @endif
                        ...
                        @if ($parcel?->return_rider)
                            ...
                            <p>Return Rider - {{ $parcel?->return_rider?->name }} - {{ $parcel?->return_rider?->r_id }}
                            </p>
                        @endif
                ...
                @php
                    $logsGroupedByDate = App\Models\ParcelLog::with(
                        'pickup_branch',
                        'pickup_rider',
                        'delivery_branch',
                        'delivery_rider',
                                ...
                                @if (!empty($parcelMerchantPaymentDeltails->count() > 0))
                                    @foreach ($parcelMerchantPaymentDeltails as $parcelMerchantPaymentDeltail)
                                        @php
                                            ...
                                            $merchant_name = $parcelMerchantPaymentDeltail
                                                ->parcel_merchant_delivery_payment->merchant
                                                ? $parcelMerchantPaymentDeltail->parcel_merchant_delivery_payment
                                    ...
                                    @foreach ($parcelBranchPaymentDeltails as $parcelBranchPaymentDetail)
                                        @php
                                            ...
                                            $branch_name = $parcelBranchPaymentDetail->parcel_delivery_payment->branch
                                                ...
                                                : 'Default';
                                            $branch_user = $parcelBranchPaymentDetail->parcel_delivery_payment
                                                ->branch_user
                                                ? ' (' .
                                                    $parcelBranchPaymentDetail->parcel_delivery_payment->branch_user
                                                        ->name .
                                                    ')'
                                                : ' (Default)';
