                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <select name="pickup_rider_id" id="pickup_rider_id" class="form-control select2"
                                                style="width: 100%">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <select name="delivery_rider_id" id="delivery_rider_id"
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            ...
                                            <select name="return_rider_id" id="return_rider_id" class="form-control select2"
                                                style="width: 100%">
...
@push('script_js')
    ...
    <script>
        window.onload = function() {
            ...
            function load_data(pickup_rider_id = "", delivery_rider_id = "", return_rider_id = "", parcel_status = "",
            ...
            $('#filter').click(function() {
                ...
                load_data(pickup_rider_id, delivery_rider_id, return_rider_id, parcel_status, merchant_id,
                    from_date, to_date);
            });
