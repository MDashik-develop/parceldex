...
<div class="main-trackParcel-page">
    <div class="trackParcel-1st-section container">
      <div class="my-5">
        <center>
          <h2 style="background-color: orange; width: max-content; padding: 0px 20px !important; border-radius: 5px; color: white;">
            Track Your Parcels</h2>
          <h1 class="mb-5">Track all your goods in real time</h1>
        </center>
        <form class="container px-5" action="#">
          <div class="row">
            <div class="input-section col-9">
            ...
            <div class="submit-section col-3">
              <div class="px-2">
